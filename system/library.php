...
function page_show($_var_15, $_var_16, $_var_17, $_var_18)
{
	...
	$_var_35 = $_var_35 . $_var_30 . $_var_31 . $_var_32 . $_var_33 . $_var_34 . '</div>';
	return $_var_35;
}
function page_shows($_var_37, $_var_38, $_var_39, $_var_40)
{
	...
	$_var_50 = '';
	$_var_51 = '';
	$_var_52 = '<div class="page_show">';
	if ($_var_42 > $_var_44 + 1) {
		$_var_48 = '<a href="' . $_var_43 . '1.html" title="首页">1...</a>';
	}
	if ($_var_42 == 1) {
		$_var_47 = '';
	} else {
